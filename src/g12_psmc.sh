...
psmc psmc -N25 -t15 -r5 -p "4+25*2+4+6" -o ${sample}/${sample}.psmc ${sample}/${sample}.split.filtered.psmcfa

rm ${sample}/${sample}.consensus.fa.gz ${sample}/${sample}.consensus.psmcfa ${sample}/${sample}.split.filtered.psmcfa
